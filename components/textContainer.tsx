...
export default function TextContainer() {
  ...
  return (
    <Grid2 className="bg-white rounded-xl w-full md:w-[80%] m-auto text-gray-400 py-4 shadow-md">
      <Container>
        <Grid2 className="flex justify-end border-b border-solid border-gray-400 border-x-0 border-t-0 pb-6 pt-4">
        ...
        <Grid2 className="flex justify-center my-2 md:my-3">
