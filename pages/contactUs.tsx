...
export default function ContactUs() {
  return (
    <MainLayout index={3}>
      <Grid2 className="bg-white rounded-lg w-full md:w-[80%] m-auto text-gray-400 py-4 mt-[6.5rem]">
        <Container className="my-4">
          ...
          <Grid2 className="my-3 flex flex-col items-end">
            <Input
              ...
              className="w-full md:w-5/12 bg-gray-200 text-gray-800 rounded-lg px-2"
              required
              disableUnderline
            />
            <Input
              placeholder="ایمیل (الزامی)"
              className="w-full md:w-5/12 bg-gray-200 text-gray-800 mt-2 rounded-lg px-2"
              required
              disableUnderline
            />
            <Input
